...
class TtsguiApp:
    def __init__(self, master=None):
        ...
        self.ui_tts_pit.configure(from_='-100', textvariable=self.val_tts_pit, to='100', width='5')
        self.ui_tts_pit.grid(column='6', pady='10', row='0')
        ...
        self.ui_tts_speed.configure(from_='-100', textvariable=self.val_tts_speed, to='100', width='5')
        self.ui_tts_speed.grid(column='8', row='0', padx='10')
        ...
        self.val_tts_playtime = tk.StringVar(value='')
        self.ui_tts_playtime.configure(text='', textvariable=self.val_tts_playtime)
        self.ui_tts_playtime.pack(padx='10', pady='12', side='top')
        ...
        self.labelframe1.configure(height='70', text='-', width='200')
        ...
        self.ui_tts_btn_stop.grid(column='2', pady='5', row='0')
        ...
        self.ui_tts_btn_download.grid(column='3', row='0')
